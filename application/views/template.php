...
<html lang="en">
    ...
    <body>
        <?php
        if ($content == "home" | $content == "tentang" | $content == "kontak" | $content == "layanan/formulir-layanan/khs" | $content == "layanan/formulir-layanan/transkip-nilai-sementara" | $content == "layanan/formulir-layanan/transkip-nilai-akhir" | $content == "layanan/formulir-layanan/lainnya/surat-keterangan-aktif-kuliah" | $content == "layanan/formulir-layanan/lainnya/surat-keterangan-berkelakuan-baik" | $content == "layanan/formulir-layanan/lainnya/surat-keterangan-masih-kuliah" | $content == "layanan/formulir-layanan/lainnya/surat-keterangan-beasiswa" | $content == "layanan/formulir-layanan/ta/pengajuan-judul" | $content == "layanan/formulir-layanan/ta/seminar-proposal" | $content == "layanan/formulir-layanan/ta/seminar-hasil" | $content == "layanan/formulir-layanan/ta/sidang") {
        ?>
        ...
        <div class="page-container">
            ...
            <div class="page-sidebar">
                ...
                <ul class="x-navigation">
                    ...
                    ?>
                    <li class="xn-openable <?php if ($active == "KHS" | $active == "Transkip Nilai Sementara" | $active == "KP" | $active == "TA" | $active == "Surat Keterangan Aktif Kuliah" | $active == "Surat Keterangan Beasiswa" | $active == "Surat Keterangan Berkelakuan Baik" | $active == "Surat Keterangan Masih Kuliah") { echo 'active'; } ?>">
                        ...
                        <ul>
                            ...
                            <li class="xn-openable <?php if ($active == "Penagajuan Judul" | $active == "Seminar Proposal" | $active == "Seminar Hasil" | $active == "Sidang") { echo 'active'; } ?>">
                                <a href="#"> TA</a>
                                <ul>
                                    <li <?php if ($active == "Penagajuan Judul") { echo 'class="active"'; } ?>><a href=""> Penagajuan Judul</a></li>
