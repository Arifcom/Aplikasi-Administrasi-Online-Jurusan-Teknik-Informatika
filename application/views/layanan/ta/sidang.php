        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Pengajuan Sidang</h3>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "koordinator-ta/layanan/ta/sidang/$datas->ta_sidang_id'>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: center;'>
                                        <a href='" . base_url() . "dosen/layanan/ta/sidang/$datas->ta_sidang_id'>
                                        <span class='fa fa-eye'></span>
                                        </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: center;'>$datas->time</td>
                                        <td style='text-align: center;'>
                                        <a href='" . base_url() . "pegawai/layanan/ta/sidang/$datas->ta_sidang_id'>
                                        <span class='fa fa-eye'></span>
                                        </a>
                                        </td>
                                    </tr>
