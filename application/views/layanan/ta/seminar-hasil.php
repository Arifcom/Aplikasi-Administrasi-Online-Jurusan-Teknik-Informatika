        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Pengajuan Seminar Hasil</h3>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "koordinator-ta/layanan/ta/seminar-hasil/$datas->ta_seminar_hasil_id'>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: center;'>
                                        <a href='" . base_url() . "dosen/layanan/ta/seminar-hasil/$datas->ta_seminar_hasil_id'>
                                        <span class='fa fa-eye'></span>
                                        </a>
                                        </td>
                                    </tr>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: center;'>$datas->time</td>
                                        <td style='text-align: center;'>
                                        <a href='" . base_url() . "pegawai/layanan/ta/seminar-hasil/$datas->ta_seminar_hasil_id'>
                                        <span class='fa fa-eye'></span>
                                        </a>
                                        </td>
                                    </tr>
