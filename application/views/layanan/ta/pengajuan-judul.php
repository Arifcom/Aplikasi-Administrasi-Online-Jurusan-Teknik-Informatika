        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Pengajuan Judul</h3>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "koordinator-ta/layanan/ta/pengajuan-judul/$datas->ta_pengajuan_judul_id'>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td style='text-align: center;'>
                                        <a href='" . base_url() . "dosen/layanan/ta/pengajuan-judul/$datas->ta_pengajuan_judul_id'>
                                        <span class='fa fa-eye'></span>
                                        </a>
                                        </td>
                                    </tr>
