        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Permohonan KHS</h3>
                </div>
                    ...
                    ?>
                        <table class="table datatable">
                            ...
                            <tbody>
                                ...
                                ?>
                                    <tr>
                                        <td style='text-align: center;'><?php $datas->nim ?></td>
                                        <td style='text-align: center;'><?php $datas->judul ?></td>
                                        <td style='text-align: center;'><?php $datas->date ?></td>
                                        <td style='text-align: center;'><?php $datas->time ?></td>
                                    </tr>
                                <?php
                                endforeach;
                                ?>                            
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "pegawai/layanan/ta/pengajuan_judul/$datas->pengajuan_judul_id'>
