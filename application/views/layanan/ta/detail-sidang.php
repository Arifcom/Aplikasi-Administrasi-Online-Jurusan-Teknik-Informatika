            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <?php echo $this->session->flashdata('flash_data'); ?>
                        <div class="block">
                            <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo base_url(); ?>pegawai/layanan/ta/sidang/replace/<?php echo $datas->ta_sidang_id ?>" method="post">
                                <div class="panel-body">          
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control datepicker" name="tanggal_sidang" value="<?php echo $datas->tanggal_sidang ?>" <?php if($this->session->userdata('hak_akses') == 'Pegawai') {} else {echo "disabled";} ?>/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control timepicker" name="waktu_sidang" value="<?php echo $datas->waktu_sidang ?>" <?php if($this->session->userdata('hak_akses') == 'Pegawai') {} else {echo "disabled";} ?>/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-md-6">
                                            <input type="text" class="form-control" name="tempat_sidang" value="<?php echo $datas->tempat_sidang ?>" <?php if($this->session->userdata('hak_akses') == 'Pegawai') {} else {echo "disabled";} ?>/>
