            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                        <div>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/ta/seminar-proposal/download/<?php echo $datas->ta_seminar_proposal_id ?>" class="btn btn-default" type="button">Word</a>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/ta/seminar-proposal/delete/<?php echo $datas->ta_seminar_proposal_id ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                    <?php
                    }
