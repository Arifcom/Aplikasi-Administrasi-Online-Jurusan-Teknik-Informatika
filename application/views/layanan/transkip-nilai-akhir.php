        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Daftar Permohonan Transkip Nilai Akhir</h3>
                </div>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td>Memohon pembuatan surat transkip nilai akhir.</td>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "pegawai/layanan/transkip-nilai-akhir/$datas->transkip_nilai_akhir_id'>
