        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Detail KHS</h3>
                    <div class="btn-group pull-right">
                        <div>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/khs/delete/<?php echo $datas->khs_id ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>
                </div>
                <div class="panel-body">
                    ...
                    <?php echo $this->session->flashdata('flash_data'); ?>
                        <div class="block">
                            <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo base_url(); ?>pegawai/layanan/khs/replace/<?php echo $datas->khs_id ?>" method="post">
