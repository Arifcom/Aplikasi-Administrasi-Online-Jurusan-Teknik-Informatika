        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Detail Surat Keterangan Berkelakuan Baik</h3>
                    <div class="btn-group pull-right">
                        <div>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/lainnya/surat-keterangan-berkelakuan-baik/download/<?php echo $datas->surat_keterangan_berkelakuan_baik_id ?>" class="btn btn-default" type="button">Word</a>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/lainnya/surat-keterangan-berkelakuan-baik/delete/<?php echo $datas->surat_keterangan_berkelakuan_baik_id ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>    
                </div>
