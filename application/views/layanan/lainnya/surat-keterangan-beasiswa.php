        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Daftar Permohonan Surat Keterangan Beasiswa</h3>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td>Memohon pembuatan surat keterangan beasiswa.</td>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "pegawai/layanan/lainnya/surat-keterangan-beasiswa/$datas->surat_keterangan_beasiswa_id'>
