        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">                                
                    <h3 class="panel-title">Daftar Permohonan Surat Keterangan Berkelakuan Baik</h3>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <td>Memohon pembuatan surat keterangan berkelakuan baik.</td>
                            ...
                            <tbody>
                                ...
                                foreach ($query as $datas):
                                    ...
                                    <tr>
                                        ...
                                        <a href='" . base_url() . "pegawai/layanan/lainnya/surat-keterangan-berkelakuan-baik/$datas->surat_keterangan_berkelakuan_baik_id'>
