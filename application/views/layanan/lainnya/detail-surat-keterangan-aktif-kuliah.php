            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    ...
                    <div class="btn-group pull-right">
                        <div>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/lainnya/surat-keterangan-aktif-kuliah/download/<?php echo $datas->surat_keterangan_aktif_kuliah_id ?>" class="btn btn-default" type="button">Word</a>
                            <a href="<?php echo base_url(); ?>pegawai/layanan/lainnya/surat-keterangan-aktif-kuliah/delete/<?php echo $datas->surat_keterangan_aktif_kuliah_id ?>" class="btn btn-danger">Delete</a>
                        </div>
                    </div>    
                </div>
                <div class="panel-body">
                    <?php echo $this->session->flashdata('flash_data'); ?>
                        <div class="block">
                            <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo base_url(); ?>pegawai/layanan/lainnya/surat-keterangan-aktif-kuliah/replace/<?php echo $datas->surat_keterangan_aktif_kuliah_id ?>" method="post">
                                <div class="panel-body">                                    
