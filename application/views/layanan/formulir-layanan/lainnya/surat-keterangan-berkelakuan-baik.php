        ...
        <div class="col-md-12">
            <div class="panel panel-default">
                <div class="panel-heading">
                    <h3 class="panel-title">Formulir Surat Keterangan Berkelakuan Baik</h3>
                </div>
                <div class="panel-body">
                    <?php echo $this->session->flashdata('flash_data'); ?>
                    <div class="block">
                        <?php echo form_open_multipart(base_url() . 'layanan/lainnya/surat-keterangan-berkelakuan-baik/insert', array('id'=>'jvalidate', 'role'=>'form', 'class'=>'form-horizontal'));?>
                        <form id="jvalidate" role="form" class="form-horizontal" action="<?php echo base_url(); ?>layanan/lainnya/surat-keterangan-berkelakuan-baik/insert" method="post">
                            <div class="panel-body">                                    
