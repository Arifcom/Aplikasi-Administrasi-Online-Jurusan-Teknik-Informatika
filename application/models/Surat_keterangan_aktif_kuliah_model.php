...
class Surat_keterangan_aktif_kuliah_model extends CI_Model {
    
    public function get_entries() {
        $query = $this->db->get('surat_keterangan_aktif_kuliah');
        return $query->result();
    }
    
    public function get_where_entries($id) {
        $query = $this->db->get_where('surat_keterangan_aktif_kuliah', array('surat_keterangan_aktif_kuliah_id' => $id));
        return $query->result();
    }
    ...
    public function insert_entry()
    {
        ...
        return $this->db->insert('surat_keterangan_aktif_kuliah', $data);
    }
