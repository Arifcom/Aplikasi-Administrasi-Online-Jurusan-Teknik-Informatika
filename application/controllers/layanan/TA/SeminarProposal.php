...
class SeminarProposal extends CI_Controller {
        ...
        {
                if ($this->session->userdata('hak_akses') == 'Pegawai') {
                    $this->ta_seminar_proposal_model->update_entry($id);
                    $this->session->set_flashdata('flash_data',
                        '
                        <div class="col-md-3"></div>
                        <div class="col-md-6">
                    ...
                    redirect(base_url() . 'pegawai/layanan/ta/seminar-proposal/' . $id);
                } else {
                    redirect(base_url() . 'authentication');
                }
        }    
        ...
        {
                if ($this->session->userdata('hak_akses') == 'Pegawai') {
                    $this->ta_seminar_proposal_model->delete_entry($id);
                    $this->session->set_flashdata('flash_data',
                        '
                        <div class="alert alert-danger" role="alert">
                        <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                    ...
                    redirect(base_url() . 'pegawai/layanan/ta/seminar-proposal');
                } else {
                    redirect(base_url() . 'authentication');
                }
        }
