...
class SuratPernyataanBebasPraktikum extends CI_Controller {
    ...
    public function insert()
    {
            ...
            redirect(base_url() . 'layanan/laboratorium/surat-pernyataan-bebas-praktikum');
    }
    
    public function replace($id)
        {
                if ($this->session->userdata('hak_akses') == 'Pegawai') {
                    $this->laboratorium_surat_pernyataan_bebas_praktikum_model->update_entry($id);
                    $this->session->set_flashdata('flash_data',
                        '
                        <div class="col-md-3"></div>
                        <div class="col-md-6">
                    ...
                    redirect(base_url() . 'pegawai/layanan/laboratorium/surat-pernyataan-bebas-praktikum/' . $id);
                } else {
                    redirect(base_url() . 'authentication');
                }
        }
    ...
    {
            if ($this->session->userdata('hak_akses') == 'Pegawai') {
                $this->laboratorium_surat_pernyataan_bebas_praktikum_model->delete_entry($id);
                $this->session->set_flashdata('flash_data',
                    '
                    <div class="alert alert-danger" role="alert">
                    <button type="button" class="close" data-dismiss="alert"><span aria-hidden="true">&times;</span><span class="sr-only">Close</span></button>
                ...
                redirect(base_url() . 'pegawai/layanan/laboratorium/surat-pernyataan-bebas-praktikum');
            } else {
                redirect(base_url() . 'authentication');
            }
    }
