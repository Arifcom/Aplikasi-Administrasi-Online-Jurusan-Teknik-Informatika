...
$route['administrator/jadwal/ekspor'] = 'jadwal/ekspor';
$route['administrator/jadwal/reset'] = 'jadwal/reset';
$route['ketua-jurusan'] = 'dashboard';
$route['ketua-jurusan/layanan/khs'] = 'layanan/khs';
$route['ketua-jurusan/layanan/kp/permohonan'] = 'layanan/kp/permohonan';
$route['ketua-jurusan/layanan/kp/seminar'] = 'layanan/kp/seminar';
$route['ketua-jurusan/layanan/laboratorium/surat-pernyataan-bebas-praktikum'] = 'layanan/suratpernyataanbebaspraktikum';
...
$route['sekretaris-jurusan/layanan/khs'] = 'layanan/khs';
$route['sekretaris-jurusan/layanan/kp/permohonan'] = 'layanan/kp/permohonan';
$route['sekretaris-jurusan/layanan/kp/seminar'] = 'layanan/kp/seminar';
$route['sekretaris-jurusan/layanan/laboratorium/surat-pernyataan-bebas-praktikum'] = 'layanan/suratpernyataanbebaspraktikum';
$route['sekretaris-jurusan/layanan/ta/pengajuan-judul'] = 'layanan/ta/pengajuanjudul';
$route['sekretaris-jurusan/layanan/ta/seminar-proposal'] = 'layanan/ta/seminarproposal';
$route['sekretaris-jurusan/layanan/ta/seminar-hasil'] = 'layanan/ta/seminarhasil';
$route['sekretaris-jurusan/layanan/ta/sidang'] = 'layanan/ta/sidang';
$route['sekretaris-jurusan/layanan/transkip-nilai-sementara'] = 'layanan/transkipnilaisementara';
$route['sekretaris-jurusan/layanan/transkip-nilai-akhir'] = 'layanan/transkipnilaiakhir';
$route['sekretaris-jurusan/layanan/lainnya/surat-keterangan-aktif-kuliah'] = 'layanan/lainnya/suratketeranganaktifkuliah';
$route['sekretaris-jurusan/layanan/lainnya/surat-keterangan-beasiswa'] = 'layanan/lainnya/suratketeranganbeasiswa';
$route['sekretaris-jurusan/layanan/lainnya/surat-keterangan-berkelakuan-baik'] = 'layanan/lainnya/suratketeranganberkelakuanbaik';
$route['sekretaris-jurusan/layanan/lainnya/surat-keterangan-masih-kuliah'] = 'layanan/lainnya/suratketeranganmasihkuliah';
$route['sekretaris-jurusan/jadwal'] = 'jadwal';
$route['sekretaris-jurusan'] = 'dashboard';
$route['kepala-laboratorium'] = 'dashboard';
$route['kepala-laboratorium/layanan/laboratorium/surat-pernyataan-bebas-praktikum'] = 'layanan/suratpernyataanbebaspraktikum';
$route['koordinator-kp'] = 'dashboard';
$route['koordinator-kp/layanan/kp/permohonan'] = 'layanan/kp/permohonan';
$route['koordinator-kp/layanan/kp/seminar'] = 'layanan/kp/seminar';
...
$route['koordinator-ta/layanan/ta/pengajuan-judul/download/(:any)'] = 'layanan/ta/pengajuanjudul/download/$1';
...
$route['dosen/layanan/ta/pengajuan-judul/download/(:any)'] = 'layanan/ta/pengajuanjudul/download/$1';
...
$route['pegawai/layanan/kp/permohonan/(:num)'] = 'layanan/kp/permohonan/detail/$1';
$route['pegawai/layanan/kp/permohonan/replace/(:num)'] = 'layanan/kp/permohonan/replace/$1';
$route['pegawai/layanan/kp/permohonan/download/(:num)'] = 'layanan/kp/permohonan/download/$1';
$route['pegawai/layanan/kp/permohonan/delete/(:num)'] = 'layanan/kp/permohonan/delete/$1';
$route['pegawai/layanan/kp/seminar'] = 'layanan/kp/seminar';
$route['pegawai/layanan/kp/seminar/(:num)'] = 'layanan/kp/seminar/detail/$1';
$route['pegawai/layanan/kp/seminar/replace/(:num)'] = 'layanan/kp/seminar/replace/$1';
$route['pegawai/layanan/kp/seminar/download/(:num)'] = 'layanan/kp/seminar/download/$1';
$route['pegawai/layanan/kp/seminar/delete/(:num)'] = 'layanan/kp/seminar/delete/$1';
...
$route['pegawai/layanan/ta/seminar-proposal/replace/(:num)'] = 'layanan/ta/seminarproposal/replace/$1';
$route['pegawai/layanan/ta/seminar-proposal/download/(:num)'] = 'layanan/ta/seminarproposal/download/$1';
$route['pegawai/layanan/ta/seminar-proposal/delete/(:num)'] = 'layanan/ta/seminarproposal/delete/$1';
...
$route['pegawai/layanan/ta/seminar-hasil/replace/(:num)'] = 'layanan/ta/seminarhasil/replace/$1';
$route['pegawai/layanan/ta/seminar-hasil/download/(:num)'] = 'layanan/ta/seminarhasil/download/$1';
$route['pegawai/layanan/ta/seminar-hasil/delete/(:num)'] = 'layanan/ta/seminarhasil/delete/$1';
$route['pegawai/layanan/ta/sidang'] = 'layanan/ta/sidang';
$route['pegawai/layanan/ta/sidang/(:num)'] = 'layanan/ta/sidang/detail/$1';
$route['pegawai/layanan/ta/sidang/replace/(:num)'] = 'layanan/ta/sidang/replace/$1';
$route['pegawai/layanan/ta/sidang/download/(:num)'] = 'layanan/ta/sidang/download/$1';
$route['pegawai/layanan/ta/sidang/delete/(:num)'] = 'layanan/ta/sidang/delete/$1';
